                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nama_bpr" name="nama_bpr" value="<?= set_value('nama_bpr'); ?>">
                                                <?php echo form_error('nama_bpr', '<div class="text-danger">', '</div>'); ?>
                                            </div>
                                            <div class="form-group">
                                                <label for="src">SRC</label>
                                                <input type="text" class="form-control" id="src" name="src" value="<?= set_value('src'); ?>">
