                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4>Daftar <?= $judul; ?></h4>
                                <a href="<?= base_url('master/user_add'); ?>" class="btn btn-info">Tambah <?= $judul; ?></a>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($user as $row) : ?>
                                            <tr>
                                                ...
                                                <td><?= $row['posisi']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('master/user_edit/' . $row['id_user']); ?>" class="btn btn-warning">Edit</a>
                                                    <a href="javascript:;" onclick="deleteUser('<?= $row['id_user'] ?>')" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
        ...
        function deleteUser(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '<?= base_url('master/user_delete/') ?>' + id + '?_csrf=' + '<?= $this->security->get_csrf_hash() ?>';
                }
            })
        }
    </script>
