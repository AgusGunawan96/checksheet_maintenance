                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4>Daftar <?= $judul; ?></h4>
                                <a href="<?= base_url('master/kantor_add'); ?>" class="btn btn-info">Tambah <?= $judul; ?></a>
                            </div>
                            <!-- flashdata -->
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($kantor as $row) : ?>
                                            <tr>
                                                ...
                                                <td><?= $row['nama_bpr']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('master/kantor_edit/' . $row['id_kantor']); ?>" class="btn btn-warning">Edit</a>
                                                    <a href="javascript:;" onclick="deleteKantor('<?= $row['id_kantor'] ?>')" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
        ...
        function deleteKantor(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '<?= base_url('master/kantor_delete/') ?>' + id + '?_csrf=' + '<?= $this->security->get_csrf_hash() ?>';
                }
            })
        }
    </script>
