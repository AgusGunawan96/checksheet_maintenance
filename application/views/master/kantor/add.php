                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nama_kantor" name="nama_kantor" value="<?= set_value('nama_kantor'); ?>">
                                                <?php echo form_error('nama_kantor', '<div class="text-danger">', '</div>'); ?>
                                            </div>
                                            <div class="form-group">
                                                <label for="kode_kantor">Kode Kantor</label>
                                                <input type="text" class="form-control" id="kode_kantor" name="kode_kantor" value="<?= set_value('kode_kantor'); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="src" name="src">
                                                    ...
                                                    <?php foreach ($bpr as $row) : ?>
                                                        <option value="<?= $row['src']; ?>"><?= $row['nama_bpr']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
