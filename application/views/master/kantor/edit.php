                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nama_kantor" name="nama_kantor" value="<?= $data['nama_kantor']; ?>">
                                                <?php echo form_error('nama_kantor', '<div class="text-danger">', '</div>'); ?>
                                            </div>
                                            <div class="form-group">
                                                <label for="kode_kantor">Kode Kantor</label>
                                                <input type="text" class="form-control" id="kode_kantor" name="kode_kantor" value="<?= $data['kode_kantor']; ?>" readonly>
                                                <?php echo form_error('kode_kantor', '<div class="text-danger">', '</div>'); ?>
                                            </div>
                                            <div class="form-group">
                                                <label for="src">BPR</label>
                                                <!-- select -->
                                                <select class="form-control" id="src" name="src">
                                                    <option value="">-- Pilih BPR --</option>
                                                    <?php foreach ($bpr as $row) : ?>
                                                        <option value="<?= $row['src']; ?>" <?= ($data['src'] == $row['src']) ? 'selected' : ''; ?>><?= $row['nama_bpr']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
